...
<a href="#files-tab" data-tab="1" class="tab">Files</a></nav>
 ...
 <div id="tab-title" class="c15657">Education History
  ...
  <div id="tab-row" class="row">
				...
				<form class="form">
						   ...
						   <div class="form-group"><select  placeholder="Educational Institution" id = "uni0" required="" class="select"><option>-- Select Education Institution --</option></select></div> 
						   ...
						   <div class="form-group"><button type="button" onClick= "addQual()" class="button">Add</button></div>
					 ...
					 <div id="form-cell" class="cell">
						<form class="form">
						   ...
						   <div class="form-group"><input id = "manager1"placeholder="Manager's Name" required="" class="input"/>
							<input id = "managerPhone1"placeholder="Manager's Contact Number" required="" class="input"/></div>
						   <div class="form-group">
						   </div>
						   <div class="form-group">
						   </div>
						   ...
						   <div class="form-group"><button type="button" class="button"onClick="addEmp()">Add</button></div>
...
?>
			   ...
			   </div><div id="contact-tab" data-tab-content="1" class="tab-content">
